...
<html lang="en">
    <head>
        ...
        <title> Search an Accessory Record </title>
    </head>
    <body>
        <!-- header -->
        ...
        <div id="container_table" class="container col-sm-12 col-md-8 offset-md-2 col-lg-10 offset-lg-1 bg-dark text-white">
            ...
            <!-- caption (header) -->
            <h3 class="text-center"> List of Acceessory Records </h3>
            
            <div class="table-responsive">
                
                <!-- table -->
                <table id="table_accessory" class="table table-sm table-striped table-dark">
