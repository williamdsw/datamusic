...
<html lang="en">
    <head>
        ...
        <title> Update an Accessory Record </title>
    </head>
    <body>
        <!-- header -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <h3 class="text-center"> Update an Accessory Record </h3>
                        </div>
                    </div>
                </div> 
                
                <!-- Hidden inputs -->
                <input type="hidden" id="accessory_id" name="accessory_id" value="<?php echo $accessory_id ?>">
        ...
        <script src="../../js/accessory-update.js"></script>
