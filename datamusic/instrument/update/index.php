...
<html lang="en">
    <head>
        ...
        <title> Update an Instrument Record </title>
    </head>
    <body>
        <!-- header -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <h3 class="text-center"> Update an Instrument Record </h3>
                        </div>
                    </div>
                </div> 
                
                <!-- Hidden inputs -->
                <input type="hidden" id="instrument_id" name="instrument_id" value="<?php echo $instrument_id ?>">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control dark-input" placeholder="*Instrument's Name" maxlength="1000" required/>
                        </div>
                    </div>
                </div>  
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control dark-input" placeholder="Instrument's Description" maxlength="1000"></textarea>
                        </div>
                    </div>
                </div>  
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="brand" name="brand" class="form-control dark-input" placeholder="*Instrument's Brand" maxlength="100" required/>
                        </div>
                    </div>
                </div> 
        ...
        <script src="../../js/instrument-update.js"></script>
